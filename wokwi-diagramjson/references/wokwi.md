...
| board-esp32-c3-rust-1 | ESP32-C3 | ESP32-C3 board designed for Rust trainings | `flashSize`, `serialInterface`, `firmwareOffset`, `macAddress`, `cpuFrequency` |
| board-xiao-esp32-c3 | ESP32-C3 | ESP32-C3 board by Seeed Studio | `flashSize`, `serialInterface`, `firmwareOffset`, `macAddress`, `cpuFrequency` |
| board-esp32-devkit-c-v4 | ESP32 | Official ESP32 devkit | `flashSize`, `serialInterface`, `firmwareOffset`, `macAddress`, `cpuFrequency` |
| wokwi-esp32-devkit-v1 | ESP32 | Unofficial ESP32 devkit | `flashSize`, `serialInterface`, `firmwareOffset`, `macAddress`, `cpuFrequency` |
| board-esp32-s3-devkitc-1 | ESP32-S3 | Entry-level ESP32-S3 | `flashSize`, `serialInterface`, `firmwareOffset`, `macAddress`, `cpuFrequency` |
| board-esp32-c6-devkitc-1 | ESP32-C6 | Entry-level ESP32-C6 | `flashSize`, `serialInterface`, `firmwareOffset`, `macAddress`, `cpuFrequency` |
| wokwi-arduino-uno | ATmega328P | Arduino Uno R3 | None documented |
| wokwi-arduino-nano | ATmega328P | Arduino Nano | None documented |
| wokwi-pi-pico | RP2040 | Raspberry Pi Pico | None documented |
